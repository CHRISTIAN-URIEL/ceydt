...
<body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <section id="atracciones" class="attractions">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="https://lugares.inah.gob.mx/images/museos/portada/_thumb1/387_A_000_IMG_3323.jpg" alt="Museo de Sitio de Cholula">
                <div class="slide-content">
            ...
            <div class="swiper-slide">
                <img src="https://lh5.googleusercontent.com/p/AF1QipN_LFKlmNzS4ZJMObi5oAKKgiSMkdjrAQeg-ts_" alt="La Casa de Frida">
                <div class="slide-content">
    ...
    <section id="transporte" class="transportation">
        ...
        <div class="transport-grid">
            ...
            <div class="transport-card">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/60/Gran_Pir%C3%A1mide_de_Cholula%2C_Puebla%2C_M%C3%A9xico%2C_2013-10-12%2C_DD_10.JPG/1280px-Gran_Pir%C3%A1mide_de_Cholula%2C_Puebla%2C_M%C3%A9xico%2C_2013-10-12%2C_DD_10.JPG" alt="Zona Arqueológica de Cholula">
            ...
            <div class="transport-card">
                <img src="https://d2dzi65yjecjnt.cloudfront.net/816945-1.jpg" alt="Iglesia de Santa María Tonantzintla">
            ...
            <div class="transport-card">
                <img src="https://thumbs.dreamstime.com/b/convento-de-san-gabriel-en-cholula-m%C3%A9xico-124441655.jpg" alt="Convento de San Gabriel">
            ...
            <div class="transport-card">
                <img src="https://www.escapadah.com/u/fotografias/m/2023/8/11/f1280x720-24609_156284_5050.png" alt="Portal Guerrero de Cholula">
    ...
    <div class="accommodation-grid">
        ...
        <div class="hotel-card">
            <img src="https://y.cdrst.com/foto/hotel-sf/ea660/granderesp/collection-o-las-iglesias-general-f8ea542.jpg" alt="Collection O Las Iglesias">
        ...
        <div class="hotel-card">
            <img src="https://pix10.agoda.net/hotelImages/367462/0/df62e2f6336f47fcf99f1b6ecb394041.jpeg?s=1024x768" alt="Hotel Casa Calli">
        ...
        <div class="hotel-card">
            <img src="https://i.travelapi.com/lodging/5000000/4220000/4212000/4211998/41d6a18e_z.jpg" alt="Maria Sofia Hotel Posada">
        ...
        <div class="hotel-card">
            <img src="https://q-xx.bstatic.com/xdata/images/hotel/max1280x900/133558838.jpg?k=bf72bae2cdcda4372cbbbc7c9e2418286d8457f7a9748f50c3c469224c49b0e6&o=" alt="Villas Hotel Cholula">
        ...
        <div class="hotel-card">
            <img src="https://media.staticontent.com/media/pictures/dbbf8d7f-2d59-4a9a-bb42-b4ebca604398" alt="Estrella de Belem">
        ...
        <div class="hotel-card">
            <img src="https://pics.tui.com/pics/pics1600x1200/tui/e/e9c8f33f441fb9db092247769a63a475_ocpprod.jpg" alt="Xoxula by Inmense">
    ...
    <div class="restaurant-grid">
        ...
        <!-- Card 2: Cus Cus Cus -->
        <div class="restaurant-card">
            <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/0a/d1/27/3a/terrace.jpg" alt="Cus Cus Cus">
            <h3>Cus Cus Cus</h3>
        ...
        <div class="restaurant-card">
            <img src="https://reservandonos-cdn.s3.us-west-2.amazonaws.com/place/3355/logo/Restaurante-Central-de-Agaves-Puebla-con-Reservandonos-17.jpg" alt="Central de Agaves">
        ...
        <!-- Card 4: La Lunita -->
        <div class="restaurant-card">
            <img src="https://media-cdn.tripadvisor.com/media/photo-s/0c/e6/a0/8c/photo0jpg.jpg" alt="La Lunita">
            <h3>La Lunita</h3>
        ...
        <!-- Card 5: Mostovoi -->
        <div class="restaurant-card">
            <img src="https://lh5.googleusercontent.com/p/AF1QipPPX4jcAG-YzVzNXIKOrwabvJaF9W_6o3HZzGE0" alt="Mostovoi">
            <h3>Mostovoi</h3>
        ...
        <div class="restaurant-card">
            <img src="https://dynamic-media-cdn.tripadvisor.com/media/photo-o/1d/19/e0/1e/ven-y-conoce-nuestra.jpg" alt="Chez Marie Bistró">
            ...
            <div class="container">
                <div class="row gy-5">
                    <div class="col-lg-4 col-sm-6">
                        <a href="#"><img src="{{ asset('assets/images/Log_cholula.webp') }}" alt="Cholula Logo"></a>
                        <div class="line"></div>
